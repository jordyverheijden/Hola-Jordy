...

{
  ...
  { es: "Malo / Mala", nl: "Slecht", example: "El servicio es malo." }
]
,
...
<ul>
  <li><b>SER (soy, eres, es, somos, sois, son):</b> Gebruik je voor vaste eigenschappen van eten/drinken, prijzen, identiteit en type gerechten.<br><em>Voorbeeld: La tortilla es un plato español. (Het is een Spaans gerecht)</em></li>
  <li><b>ESTAR (estoy, estás, está, estamos, estáis, están):</b> Gebruik je voor temperatuur, actuele smaak, toestand en locaties.<br><em>Voorbeeld: La sopa está caliente. (De soep is [nu] warm) / El restaurante está aquí. (Locatie)</em></li>
</ul>`,
  questionBank: [
    ...
    { type: "multiple-choice", question: "Kies de juiste vorm: 'El café ... caliente' (het is warm ingesteld)", options: ["está", "es", "somos", "están"], correctIndex: 0 },
    ...
    { type: "input", question: "Vertaal 'Het toetje is zoet' (vaste eigenschap van een dessert):", correctAnswer: "El postre es dulce" },
    ...
    { type: "input", question: "Vertaal 'De tafel is schoon' (limpia):", correctAnswer: "La mesa está limpia" },
    ...
    { type: "input", question: "Vertaal 'Het restaurant is erg mooi' (bonito - vaste eigenschap):", correctAnswer: "El restaurante es muy bonito" },
    ...
    { type: "multiple-choice", question: "Wat is het verschil tussen 'es dulce' en 'está dulce'?", options: ["es = zoet van zichzelf, está = zoet van smaak (bijv. te veel suiker toegevoegd)", "Er is geen verschil", "es gebruik je voor de rekening", "está gebruik je voor de ober"], correctIndex: 0 },
    ...
    { type: "input", question: "Vertaal 'Het glas is leeg' (vacío):", correctAnswer: "El vaso está vacío" },
    ...
    { type: "input", question: "Vertaal 'De ober is vriendelijk' (amable - eigenschap):", correctAnswer: "El camarero es amable" },
    ...
    { type: "multiple-choice", question: "Wat is de 'yo'-vorm als je zegt dat je hongerig/klaar bent? 'Yo ... listo'", options: ["estoy", "soy", "es", "son"], correctIndex: 0 },
    ...
    { type: "input", question: "Vertaal 'Ik ben vegetariër' (vegetariano):", correctAnswer: "Soy vegetariano" },
    ...
    { type: "input", question: "Vertaal 'Het restaurant is gesloten' (cerrado):", correctAnswer: "El restaurante está cerrado" },
    { type: "multiple-choice", question: "Kies de juiste vorm voor 'Dit gerecht ... typisch Spaans' (eigenschap):", options: ["es", "está", "están", "somos"], correctIndex: 0 },
    ...
    { type: "multiple-choice", question: "Wat is de juiste vorm: 'Ustedes ... en el centro'?", options: ["están", "son", "estamos", "somos"], correctIndex: 0 },
    ...
    { type: "input", question: "Vertaal 'De wijn is rood' (tinto - eigenschap):", correctAnswer: "El vino es tinto" },
